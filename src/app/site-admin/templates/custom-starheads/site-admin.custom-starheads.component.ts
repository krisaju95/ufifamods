...
@Component({
	selector: 'site-admin-custom-starheads',
	templateUrl: './site-admin.custom-starheads.component.html',
	styleUrls: ['./site-admin.custom-starheads.component.scss']
})

export class SiteAdminCustomStarHeadsComponent {
